...
const FOOTER_GROUPS: Record<string, FooterLink[]> = {
  Services: [
    ...
    { label: 'Web development', href: '/web-development-south-africa' },
    { label: 'AI software development', href: '/ai-software-development-company' },
    { label: 'Digital transformation', href: '/digital-transformation-south-africa' },
  ...
  Resources: [
    ...
    { label: 'Developers (Eastern Cape)', href: '/developers/eastern-cape' },
    { label: 'Developers (Gauteng)', href: '/developers/gauteng' },
    { label: 'App development cost', href: APP_DEVELOPMENT_COST_PAGE },
    { label: 'Software dev pricing', href: '/software-development-pricing' },
